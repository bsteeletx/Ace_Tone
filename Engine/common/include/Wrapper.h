...
namespace AGK
{
	...
	class agk
	{
		...
		protected:
			...
			// RATING COMMANDS
			static void  PlatformRateApp                      ( char* szID, const char* title, const char* message );

			// IN APP PURCHASE COMMANDS
			static void  PlatformInAppPurchaseSetTitle        ( char* szTitle );
			static void  PlatformInAppPurchaseAddProductID    ( char* szID, int type );
		...
		public:
            ...
            static void  RateApp                      ( char* szID, const char* title );
			static void  RateApp                      ( char* szID, const char* title, const char* message );

			// IN APP PURCHASE COMMANDS
			static void  InAppPurchaseSetTitle        ( char* szTitle );
			static void  InAppPurchaseAddProductID    ( char* szID, int type );
