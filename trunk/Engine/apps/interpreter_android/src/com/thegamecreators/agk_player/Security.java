...
import com.thegamecreators.agk_player.Consts.PurchaseState;
import com.thegamecreators.agk_player.util.Base64;
import com.thegamecreators.agk_player.util.Base64DecoderException;
...
public class Security {
    ...
    public static ArrayList<VerifiedPurchase> verifyPurchase(String signedData, String signature) {
        ...
        if (!TextUtils.isEmpty(signature)) {
             ...
             */
            String base64EncodedPublicKey = "";
