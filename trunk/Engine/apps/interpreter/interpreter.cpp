...
void app::UpdateInterpreterAspect ( void )
{
	...
	if ( g_pAGKBackdrop.pSprite )
	{
		...
		{
			// landscape or square
			if ( g_pAGKBackdrop.pSprite ) g_pAGKBackdrop.pSprite->SetSize ( 100, 100*fAspect );
			if ( g_pAGKBackdrop.pSprite ) g_pAGKBackdrop.pSprite->SetPosition ( 0, (100-(100*fAspect))/2.0f );
			if ( g_pAGKBackdropSpinner.pSprite ) g_pAGKBackdropSpinner.pSprite->SetSize ( 70/fAspect, 70 );
			if ( g_pAGKBackdropSpinner.pSprite ) g_pAGKBackdropSpinner.pSprite->SetPosition ( 50-((70/fAspect)/2.0f), 25-10 );
			if ( g_pAGKBackdropLogo.pSprite ) g_pAGKBackdropLogo.pSprite->SetSize ( 50/fAspect, 50 );
			if ( g_pAGKBackdropLogo.pSprite ) g_pAGKBackdropLogo.pSprite->SetPosition ( 50-((50/fAspect)/2.0f), 50-(50/2.0f) );
		}
		else
		{
			// portrait
			if ( g_pAGKBackdrop.pSprite ) g_pAGKBackdrop.pSprite->SetSize ( 100/fAspect, 100 );
			if ( g_pAGKBackdrop.pSprite ) g_pAGKBackdrop.pSprite->SetPosition ( (100-(100/fAspect))/2.0f, 0 );
			if ( g_pAGKBackdropSpinner.pSprite ) g_pAGKBackdropSpinner.pSprite->SetSize ( 70, 70*fAspect );
			if ( g_pAGKBackdropSpinner.pSprite ) g_pAGKBackdropSpinner.pSprite->SetPosition ( 25-10, 50-((70*fAspect)/2.0f) );
			if ( g_pAGKBackdropLogo.pSprite ) g_pAGKBackdropLogo.pSprite->SetSize ( 50, 50*fAspect );
			if ( g_pAGKBackdropLogo.pSprite ) g_pAGKBackdropLogo.pSprite->SetPosition ( 50-(50/2.0f), 50-((50*fAspect)/2.0f) );
		}
		if ( g_pAGKBackdropPower.pSprite ) g_pAGKBackdropPower.pSprite->SetSize ( 10/fAspect, 10 );
		if ( g_pAGKBackdropPower.pSprite ) g_pAGKBackdropPower.pSprite->SetPosition ( 99-(10/fAspect), 1 );
	}
}
...
void app::Loop ( void )
{
	...
	*/
	...
	// both L3 and R3 stick buttons pressed whilst both L1 and R1 shoulder buttons are pressed
	if ( g_iAppIsStandalone==0 && agk::GetRawJoystickExists(1) == 1 ) 
	{
